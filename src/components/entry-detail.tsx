...
function renderContent(entry: Entry) {
  ...
  return <div className="prose prose-lg dark:prose-invert max-w-none prose-a:text-primary hover:prose-a:opacity-80 text-foreground" dangerouslySetInnerHTML={{ __html: entry.notes }} />;
}
